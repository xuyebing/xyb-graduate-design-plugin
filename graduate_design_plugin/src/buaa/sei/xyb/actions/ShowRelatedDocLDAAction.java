...
public class ShowRelatedDocLDAAction implements IObjectActionDelegate {
	...
	public ShowRelatedDocLDAAction() {
	...
	public void run(IAction action) {
		...
		if (selection instanceof IStructuredSelection) {
			...
			try {
				if(view==null)
				{
					view=PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage().showView(("buaa.sei.xyb.RelatedDocsResultViewLDA"));			    
				}
				else
					{
					     //view.dispose();
					     ...
					     view=PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage().showView(("buaa.sei.xyb.RelatedDocsResultViewLDA"));//就是调用TreeTableLDA.java
					}
