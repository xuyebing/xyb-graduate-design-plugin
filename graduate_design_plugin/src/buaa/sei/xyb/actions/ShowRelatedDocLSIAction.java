...
public class ShowRelatedDocLSIAction implements IObjectActionDelegate {
	...
	public ShowRelatedDocLSIAction() {
	...
	public void run(IAction action) {
		...
		if (selection instanceof IStructuredSelection) {
			...
			try {
				if(view==null)
				{
					view=PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage().showView(("buaa.sei.xyb.RelatedDocsResultViewLSI"));			    
				}
				else
					{
					     //view.dispose();
					     ...
					     view=PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage().showView(("buaa.sei.xyb.RelatedDocsResultViewLSI"));//就是调用TreeTableLSI.java
					}
