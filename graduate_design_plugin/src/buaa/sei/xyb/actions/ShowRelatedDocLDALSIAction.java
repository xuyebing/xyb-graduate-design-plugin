...
public class ShowRelatedDocLDALSIAction implements IObjectActionDelegate {
	...
	public ShowRelatedDocLDALSIAction() {
	...
	public void run(IAction action) {
		...
		if (selection instanceof IStructuredSelection) {
			...
			try {
				if(view==null)
				{
					view=PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage().showView(("buaa.sei.xyb.RelatedDocsResultViewLDALSI"));			    
				}
				else
					{
					     //view.dispose();
					     ...
					     view=PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage().showView(("buaa.sei.xyb.RelatedDocsResultViewLDALSI"));//就是调用TreeTableVSM.java
					}
